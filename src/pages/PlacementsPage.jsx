      ...
      <div style={{ padding:"18px 20px 20px" }}>
        ...
        <div style={{ display:"flex",justifyContent:"space-between",alignItems:"flex-end",flexWrap:"wrap",gap:10 }}>
          ...
          <div style={{ display:"flex",gap:8,alignItems:"center" }}>
            {item.beat && (
              <Link to="/beats" style={{ fontSize:"clamp(9px, 1.1vw, 10px)",letterSpacing:"0.18em",textTransform:"uppercase",border:"1px solid rgba(176,42,26,0.35)",padding:"5px 12px",borderRadius:20,color:"var(--red)",transition:"all .2s" }}
  ...
  return (
    ...
    >
      ...
      <div style={{ display:"flex",flexDirection:"column",alignItems:"flex-end",gap:8,flexShrink:0 }}>
        ...
        {item.beat && (
          <Link to="/beats" style={{ fontSize:"clamp(8px, 1vw, 9px)",letterSpacing:"0.15em",textTransform:"uppercase",color:"var(--red)",transition:"opacity .2s" }}
            ...
            <div style={{ border:"1px solid rgba(221,216,204,0.07)",borderRadius:12,overflow:"hidden",background:"rgba(221,216,204,0.02)",display:"flex",gap:0 }}>
              ...
              <div style={{ padding:"28px 28px",display:"flex",gap:28,alignItems:"center",flex:1,flexWrap:"wrap" }}>
                ...
                <div style={{ display:"flex",flexDirection:"column",gap:10 }}>
                  <Link to="/beats" style={{ fontSize:"clamp(10px, 1.2vw, 11px)",letterSpacing:"0.2em",textTransform:"uppercase",padding:"8px 20px",border:"1px solid rgba(221,216,204,0.12)",borderRadius:6,color:"var(--offwhite)",transition:"all .2s",textAlign:"center" }}
                  ...
                  >Browse Beats</Link>
                  <Link to="/#contact" style={{ fontSize:"clamp(10px, 1.2vw, 11px)",letterSpacing:"0.2em",textTransform:"uppercase",padding:"8px 20px",background:"var(--red)",borderRadius:6,color:"var(--offwhite)",transition:"opacity .2s",textAlign:"center" }}
          ...
          <div style={{ position:"relative",zIndex:2 }}>
            <motion.div initial={{opacity:0,y:16}} whileInView={{opacity:1,y:0}} viewport={{once:true}} transition={{duration:.8}}>
              ...
              <div style={{ display:"flex",gap:12,justifyContent:"center",flexWrap:"wrap" }}>
                <Link to="/beats" style={{ padding:"13px 32px",border:"1px solid rgba(221,216,204,0.12)",borderRadius:6,fontFamily:"'Bebas Neue',sans-serif",fontSize:"0.9rem",letterSpacing:"0.2em",color:"var(--offwhite)",transition:"all .2s" }}
                  onMouseEnter={e=>e.currentTarget.style.borderColor="rgba(221,216,204,0.3)"}
                  onMouseLeave={e=>e.currentTarget.style.borderColor="rgba(221,216,204,0.12)"}
                >Browse Beats</Link>
                <Link to="/#contact" style={{ padding:"13px 32px",background:"var(--red)",borderRadius:6,fontFamily:"'Bebas Neue',sans-serif",fontSize:"0.9rem",letterSpacing:"0.2em",color:"var(--offwhite)",transition:"opacity .2s" }}
                  onMouseEnter={e=>e.currentTarget.style.opacity=".8"}
                  onMouseLeave={e=>e.currentTarget.style.opacity="1"}
                >Get in Touch</Link>
              </div>
